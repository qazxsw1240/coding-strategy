...
namespace CodingStrategy.UI.InGame
{
    public class SetCommandDetail : MonoBehaviour
    {
        ...
        public enum AttackArea { None, Forward, Left, Right, Backward, Forward2, Forward3, Backward3, ForwardLeft, ForwardRight, Malware2, Malware3, Around };
        public string Id;
        ...
        void SetCommandAttackRange(int enhancedLevel)
        {
            switch (int.Parse(Id))
            {
                ...
                case 12:
                    ...
                    break;
                case 13:
                    _attackRange.sprite = spriteList[(int)(enhancedLevel == 1 || enhancedLevel == 2 ? AttackArea.Forward :
                                                        enhancedLevel == 3 ? AttackArea.Forward3 : AttackArea.None)];
                    break;
                case 14:
                    _attackRange.sprite = spriteList[(int)(enhancedLevel == 1 || enhancedLevel == 2 ? AttackArea.Backward :
                                                        enhancedLevel == 3 ? AttackArea.Backward3 : AttackArea.None)];
                    break;
                case 15:
                    _attackRange.sprite = spriteList[(int)(enhancedLevel == 1 || enhancedLevel == 2 ? AttackArea.Forward :
                                                        enhancedLevel == 3 ? AttackArea.Forward3 : AttackArea.None)];
